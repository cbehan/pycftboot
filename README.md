...
PyCFTBoot is still in the early stages but it supports bounds on scaling dimensions and OPE coefficients in an arbitrary number of spacetime dimensions. These can come from a correlator of identical scalars or scalars in the same multiplet of a global symmetry.
